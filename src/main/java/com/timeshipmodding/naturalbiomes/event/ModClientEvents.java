...
import com.timeshipmodding.naturalbiomes.content.entity.client.registries.ModModelLayers;
import com.timeshipmodding.naturalbiomes.content.entity.client.renderers.AspenBoatRenderer;
...
@EventBusSubscriber(modid = NaturalBiomes.MODID, value = Dist.CLIENT)
