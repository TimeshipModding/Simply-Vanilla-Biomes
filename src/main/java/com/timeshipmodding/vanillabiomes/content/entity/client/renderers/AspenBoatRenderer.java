package com.timeshipmodding.vanillabiomes.content.entity.client.renderers;
...
public class AspenBoatRenderer extends BoatRenderer {
    ...
    public AspenBoatRenderer(EntityRendererProvider.Context context, boolean chestBoat) {
        ...
        this.boatResources = Stream.of(AspenBoatEntity.Type.values()).collect(ImmutableMap.toImmutableMap(type -> type,
                type -> Pair.of(ResourceLocation.fromNamespaceAndPath(VanillaBiomes.MODID, getTextureLocation(type, chestBoat)), this.createBoatModel(context, type, chestBoat))));
    }
    ...
    private static ModelLayerLocation createLocation(String path, String model) {
        return new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(VanillaBiomes.MODID, path), model);
    }
